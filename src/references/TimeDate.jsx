...
const getActiveSchedule = (daySchedules) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (modalType === 'closeday') {
      ...
      const openTime = parseInt(formData.OpenTime);
      const closeTime = parseInt(formData.CloseTime);

      if (openTime < 0 || openTime > 23 || closeTime < 0 || closeTime > 23) {
        Swal.fire({
          icon: 'warning',
          title: 'Invalid Time',
          text: 'Time must be between 0 (12 AM) and 23 (11 PM)',
        });
        return;
      }
  ...
  const handleEdit = (timeDate) => {
    ...
    if (timeDate.CloseDay) {
      ...
      setFormData({
        Date: timeDate.Date || '',
        OpenTime: timeDate.OpenTime?.toString() || '',
        CloseTime: timeDate.CloseTime?.toString() || '',
    ...
    💡 Select the day of the week for this schedule
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '20px' }}>
                    <div>
                      ...
                      <p style={{ fontSize: '12px', color: '#28a745', marginTop: '5px', fontWeight: '600' }}>
                        {formData.OpenTime !== '' && formatTime(formData.OpenTime)}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '12px', color: '#dc3545', marginTop: '5px', fontWeight: '600' }}>
                        {formData.CloseTime !== '' && formatTime(formData.CloseTime)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '13px', color: '#004085' }}>
                      ...
                      • 0 = 12:00 AM • 6 = 6:00 AM • 8 = 8:00 AM<br />
                      • 10 = 10:00 AM • 12 = 12:00 PM • 18 = 6:00 PM<br />
